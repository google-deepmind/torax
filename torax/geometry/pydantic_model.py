...
class CircularConfig(torax_pydantic.BaseModelFrozen):
  ...
  geometry_type: Literal['circular'] = 'circular'
...
class CheaseConfig(torax_pydantic.BaseModelFrozen):
  ...
  geometry_type: Literal['chease'] = 'chease'
  n_rho: Annotated[pydantic.PositiveInt, torax_pydantic.TIME_INVARIANT] = 25
  hires_fac: pydantic.PositiveInt = 4
  geometry_dir: Annotated[str | None, torax_pydantic.TIME_INVARIANT] = None
...
class EQDSKConfig(torax_pydantic.BaseModelFrozen):
  ...
  geometry_type: Literal['eqdsk'] = 'eqdsk'
  n_rho: Annotated[pydantic.PositiveInt, torax_pydantic.TIME_INVARIANT] = 25
  hires_fac: pydantic.PositiveInt = 4
  geometry_dir: Annotated[str | None, torax_pydantic.TIME_INVARIANT] = None
  Ip_from_parameters: Annotated[bool, torax_pydantic.TIME_INVARIANT] = True
...
def _conform_user_data(data: dict[str, Any]) -> dict[str, Any]:
  ...
  data_copy = data.copy()
  # Some test cases use upper case for the geometry type.
