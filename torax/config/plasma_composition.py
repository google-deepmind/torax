...
class PlasmaCompositionPydantic(torax_pydantic.BaseModelFrozen):
  ...
  Zi_override: interpolated_param.TimeInterpolatedInput | None = None
  Ai_override: interpolated_param.TimeInterpolatedInput | None = None
  Zimp_override: interpolated_param.TimeInterpolatedInput | None = None
  Aimp_override: interpolated_param.TimeInterpolatedInput | None = None
