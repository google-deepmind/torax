...
from torax import JAX_STATIC, CoreProfiles, Geometry, pedestal
...
class EPEDLikePedestalModel(pedestal.PedestalModel):
    ...
    def _call_implementation(
        ...
        rho_norm_ped_top_idx = jnp.argmin(jnp.abs(geo.rho_norm - rho_norm_ped_top))
...
CONFIG = {
    ...
    "plasma_composition": {},
    "numerics": {},
    "geometry": {"geometry_type": "circular", "n_rho": 25},
    "sources": {},
    "solver": {},
    "transport": {},
    "pedestal": {
