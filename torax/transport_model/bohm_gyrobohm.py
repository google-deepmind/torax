...
class RuntimeParamsProvider(runtime_params_lib.RuntimeParamsProvider):
  ...
  def build_dynamic_params(self, t: chex.Numeric) -> DynamicRuntimeParams:
    return DynamicRuntimeParams(
        ...
        chi_e_bohm_coeff=float(self.chi_e_bohm_coeff.get_value(t)),
        chi_e_gyrobohm_coeff=float(self.chi_e_gyrobohm_coeff.get_value(t)),
        chi_i_bohm_coeff=float(self.chi_i_bohm_coeff.get_value(t)),
        chi_i_gyrobohm_coeff=float(self.chi_i_gyrobohm_coeff.get_value(t)),
        d_face_c1=float(self.d_face_c1.get_value(t)),
        d_face_c2=float(self.d_face_c2.get_value(t)),
    )
