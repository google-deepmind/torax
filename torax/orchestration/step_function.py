...
class SimulationStepFn:
  ...
  def __call__(
    ...
    if (self.mhd_models.sawtooth is not None) and (
      ...
      output_state, post_processed_outputs = _handle_sawtooth(
    ...
    output_state, post_processed_outputs = finalize_outputs(
        x_new=x_new,
  ...
  def adaptive_step(
    ...
    Returns:
      A tuple containing:
        - tuple of CellVariables corresponding to the evolved state variables
        - An intermeediate ToraxSimState after adaptive time stepping, complete
