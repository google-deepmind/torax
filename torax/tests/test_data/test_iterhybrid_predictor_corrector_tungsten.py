...
"""Identical to test_iterhybrid_predictor_corrector but with tungsten and average charge state calculations."""
import copy
...
CONFIG['runtime_params']['plasma_composition']['impurity'] = {'W': 1.0}
