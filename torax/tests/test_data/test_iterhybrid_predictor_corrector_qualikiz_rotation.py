...
"""QuaLiKiz with rotation model."""

import copy

from torax.tests.test_data import test_iterhybrid_predictor_corrector_qualikiz
...
core_models['qualikiz']['rotation_mode'] = 'half_radius'
