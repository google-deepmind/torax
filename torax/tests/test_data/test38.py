...
"""test38: CHEASE geometry.

Ip from parameters. current, heat, and particle transport. CGM transport model.
Pedestal. Particle sources including NBI. Self-consistent fusion power.
"""
