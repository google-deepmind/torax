...
"""Like test_iterhybrid_rampup but configured to run for less time.

This is useful for tests that emphasize compilation time, like
tests/persistent_cache
"""
...
CONFIG = {
    ...
    'numerics': {
        # simulation control
        't_final': 2,  # length of simulation time in seconds
        # Note: we're not guaranteed to end simulation in a single Newton
        # step due to the dt_reduction loop
        'fixed_dt': 2,
