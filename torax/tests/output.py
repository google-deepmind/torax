  ...
  def test_load_core_profiles_from_xr(self):
    ...
    with open(path, 'rb') as f:
      ...
      np.testing.assert_allclose(
          ds.data_vars[output.TEMP_EL_VALUE].values[0, :],
      ...
      np.testing.assert_allclose(
          ds.data_vars[output.TEMP_ION_VALUE].values[0, :],
      ...
      np.testing.assert_allclose(
          ds.data_vars[output.PSI_VALUE].values[0, :],
      ...
      np.testing.assert_allclose(
          ds.data_vars[output.NE_VALUE].values[0, :],
