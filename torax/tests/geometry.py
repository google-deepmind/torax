...
class GeometryTest(parameterized.TestCase):
  ...
  def test_standard_geometry_can_be_input_to_jitted_function(self):
    ...
    intermediate = geometry.StandardGeometryIntermediates(
        ...
        rho=np.arange(0, 1.0, 0.01),
        rhon=np.arange(0, 1.0, 0.01),
        Rin=np.arange(0, 1.0, 0.01),
        Rout=np.arange(0, 1.0, 0.01),
        RBphi=np.arange(0, 1.0, 0.01),
        int_Jdchi=np.arange(0, 1.0, 0.01),
        flux_norm_1_over_R2=np.arange(0, 1.0, 0.01),
        flux_norm_Bp2=np.arange(0, 1.0, 0.01),
        flux_norm_dpsi=np.arange(0, 1.0, 0.01),
        flux_norm_dpsi2=np.arange(0, 1.0, 0.01),
