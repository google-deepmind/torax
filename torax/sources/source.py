...
class SourceProfileFunction(Protocol):
  ...
  def __call__(
      ...
      caculated_source_profiles: source_profiles.SourceProfiles | None,
  ...
  def get_value(
    ...
    Args:
      ...
      calculated_source_profiles: The source profiles which have already been
        ...
        profiles will only exist if the source is explicit and then also
        depends on the source type, see source_profile_builders.py for more
        details.
