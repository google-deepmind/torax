...
class SourceModels:
  ...
  .. code-block:: python
    ...
    gas_puff_source_builder = source_lib.make_source_builder(
        ...
        runtime_params_type=gas_puff_source.model_functions['default'].runtime_params_class,
        model_func=gas_puff_source.model_functions['default'].source_profile_function,
    )
