...
def register_torax_sources():
  ...
  register_new_source(
      'ohmic_heat_source',
      source_models_lib.OhmicHeatSource,
      default_runtime_params_class=source_models_lib.OhmicRuntimeParams,
      source_builder_class=source_models_lib.OhmicHeatSourceBuilder,
  )
  register_new_source(
