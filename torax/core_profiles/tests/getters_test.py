...
class GettersTest(parameterized.TestCase):
  ...
  @parameterized.parameters(
      # When normalize_to_nbar=False, take n_e_bound_right from n_e[0.0][1.0]
      (None, False, 1.0),
      # Take n_e_bound_right from provided value.
      (0.85, False, 0.85),
      # normalize_to_nbar=True, n_e_bound_right from n_e[0.0][1.0] and normalize
      (None, True, 0.8050314),
  ...
  def test_n_e_core_profile_setter_with_fGW(
    ...
    profile_conditions._update_fields({'n_e_is_fGW': False})
