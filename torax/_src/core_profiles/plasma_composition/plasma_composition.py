...
class DynamicPlasmaComposition:
  ...
  impurity: DynamicIonMixture | n_e_ratios.DynamicNeRatios | DynamicNeRatiosZeff
...
class PlasmaComposition(torax_pydantic.BaseModelFrozen):
  ...
  impurity: Annotated[
      ImpurityFractionsModel | n_e_ratios.NeRatiosModel | NeRatiosZeffModel,
  ...
  def _check_zeff_usage(self) -> typing_extensions.Self:
    ...
    if (
        isinstance(self.impurity, n_e_ratios.NeRatiosModel)
