...
class MavrinImpurityRadiationHeatSinkTest(test_lib.SingleProfileSourceTestCase):
  ...
  @parameterized.named_parameters(
      ...
      (
          ...
          {'Kr': 1.0},
          [0.1, 2, 10],
          [3.288289e-32, 3.235129e-32, 7.532862e-33],
      ),
      (
          'Xenon',
          {'Xe': 1.0},
          [0.1, 2, 10],
          [1.448672e-31, 8.969181e-32, 2.877398e-32],
      ),
      (
          'Tungsten',
          {'W': 1.0},
          [0.1, 2, 10],
          [8.331822e-32, 4.466520e-31, 1.312230e-31],
      ),
      (
          'Mixture',
          {
          ...
          [0.1, 2, 10],
          [2.486582e-33, 1.040501e-33, 3.932562e-34],
      ),
  )
