...
class SourceModelsTest(parameterized.TestCase):
  ...
  def test_equal_hash_and_eq_same_config(self):
    ...
    # Simulate JAX cache hit
    mock_cache = {self.default_source_model}
    self.assertIn(test_source_model, mock_cache)
  ...
  def test_hash_and_eq_different_with_different_standard_source(self):
    ...
    # Simulate JAX cache miss
    mock_cache = {self.default_source_model}
    self.assertNotIn(test_source_model, mock_cache)
