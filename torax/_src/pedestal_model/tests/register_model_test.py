...
from torax._src.pedestal_model import pedestal_model, pydantic_model, register_model
    ...
    def test_register_custom_pedestal_model(self):
        ...
        class TestPedestal(pydantic_model.BasePedestal):
            ...
            model_name: Annotated[
                Literal["test_pedestal"], torax_pydantic.JAX_STATIC
            ] = "test_pedestal"
            test_value: float = 42.0
            ...
            def build_runtime_params(self, t: chex.Numeric) -> TestRuntimeParams:
