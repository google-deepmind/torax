...
"""Pydantic config for extended_lengyel models."""
...
from torax._src.edge import runtime_params
...
class ExtendedLengyelConfig(base.EdgeModelConfigBase):
  ...
  def build_runtime_params(
      self, t: chex.Numeric
  ) -> runtime_params.ExtendedLengyelRuntimeParams:
    # TODO(b/446608829) - to be completed in a later PR.
    return runtime_params.ExtendedLengyelRuntimeParams()
