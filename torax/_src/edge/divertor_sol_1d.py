...
class DivertorSOL1D:
  ...
  # Other input physics parameters
  ...
  @property
  def kappa_e(self) -> array_typing.FloatScalar:
    ...
    return extended_lengyel_formulas.KAPPA_E_0 / kappa_z
  ...
  def electron_temp_at_cc_interface(self) -> array_typing.FloatScalar:
    ...
    return self.target_electron_temp / (
        (1.0 - momentum_loss) / (2.0 * density_loss)
    )
  ...
  @property
  def separatrix_electron_temp(self) -> array_typing.FloatScalar:
