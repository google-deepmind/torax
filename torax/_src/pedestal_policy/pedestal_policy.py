...
class PedestalPolicy(abc.ABC):
  ...
  @abc.abstractmethod
  def update(self, t: float) -> PedestalPolicyState:
  ...
  def tree_flatten(self):
    """Flattens the PedestalPolicy object for JAX."""
    # Subclasses should override this to return children and aux_data
    return (), None

  @classmethod
  def tree_unflatten(cls, aux_data, children):
    """Unflattens the PedestalPolicy object for JAX."""
