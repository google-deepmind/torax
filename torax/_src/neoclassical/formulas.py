...
def calculate_f_trap(geo: geometry_lib.Geometry) -> array_typing.Array:
...
def calculate_nu_e_star(
    ...
    Z_eff: array_typing.Array,
    log_lambda_ei: array_typing.Array,
) -> array_typing.Array:
...
def calculate_nu_i_star(
    ...
    Z_eff: array_typing.Array,
    log_lambda_ii: array_typing.Array,
) -> array_typing.Array:
