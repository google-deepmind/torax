...
def _calculate_Kmn(
    ftrap: array_typing.Array,
    ftrap_d: array_typing.Array,
    Z_eff: array_typing.Array,
    B2_avg_Bm2_avg: array_typing.Array,
    nu_e_star: array_typing.Array,
    nu_i_star: array_typing.Array,
    alpha_I: array_typing.Array,
...
def _Fmn_X(
    X: array_typing.Array, Z_eff: array_typing.Array
) -> array_typing.Array:
...
def _calculate_Lmn(
    ...
    core_profiles: state.CoreProfiles,
    epsilon: array_typing.Array,
    nu_e_star: array_typing.Array,
    nu_i_star: array_typing.Array,
    B2_avg: array_typing.Array,
    Bm2_avg: array_typing.Array,
) -> tuple[array_typing.Array, array_typing.Array]:
