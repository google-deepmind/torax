...
class NeoclassicalTransportTest(absltest.TestCase):
    def setUp(self):
        ...
        self._original_neoclassical_transport_annotation = (
    ...
    def tearDown(self):
        ...
        neoclassical_pydantic_model.Neoclassical.model_fields[
            "transport"
        ].annotation = self._original_neoclassical_transport_annotation
        neoclassical_pydantic_model.Neoclassical.model_rebuild(force=True)
        model_config.ToraxConfig.model_rebuild(force=True)
    ...
    def test_clipping(self):
        ...
        neoclassical_transport_model = torax_config.neoclassical.transport.build_model()
