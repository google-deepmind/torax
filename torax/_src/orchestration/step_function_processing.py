...
def _update_pedestal_transition_state(
  ...
  # H-mode. The pedestal top location comes from the pedestal runtime params.
  # We use getattr with a fallback for type safety, though the assert above
  # guarantees the attribute exists for PowerScaling pedestal models.
  rho_norm_ped_top = getattr(runtime_params.pedestal, 'rho_norm_ped_top', 0.91)
