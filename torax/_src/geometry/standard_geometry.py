...
from torax._src import array_typing, constants, interpolated_param
...
class StandardGeometryIntermediates:
  ...
  Attributes:
    ...
    flux_surf_avg_grad_psi: Flux surface average of :math:`|\nabla \psi| = R B_p`
      [:math:`\mathrm{m T}`] (COCOS11).
    flux_surf_avg_grad_psi2: Flux surface average of
      :math:`|\nabla \psi|^2 = R^2 B_p^2` [:math:`\mathrm{m^2 T^2}`] (COCOS11).
    flux_surf_avg_grad_psi2_over_R2: Flux surface average of
      :math:`|\nabla \psi|^2 / R^2 = B_p^2` [:math:`\mathrm{T^2}`] (COCOS11).
  ...
  def __post_init__(self):
    ...
    if self.flux_surf_avg_grad_psi2_over_R2[-1] < 1e-10:
      # Calculate rhon
