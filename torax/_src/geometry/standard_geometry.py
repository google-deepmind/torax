...
class StandardGeometryIntermediates:
  ...
  def from_eqdsk(
    ...
    psi_contour_generator = contourpy.contour_generator(X, Z, psi_eqdsk_2dgrid)
    sep_vertices = psi_contour_generator.create_contour(
      (eqfile['psibdry'] - eqfile['psimag']) * 0.9999
    )
