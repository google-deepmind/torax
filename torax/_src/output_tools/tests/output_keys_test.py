...
class OutputKeysTest(absltest.TestCase):
  ...
  def test_output_key_copy(self):
    ...
    self.assertEqual(copied.units, key.units)
    self.assertEqual(copied.grid_type, key.grid_type)
