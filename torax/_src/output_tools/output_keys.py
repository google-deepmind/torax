...
# Core profiles.
# ---------------------------------------------------------------------------
T_E = OutputKey("T_e", units=Units.KEV, grid_type=GridType.CELL_PLUS_BOUNDARIES)
T_I = OutputKey("T_i", units=Units.KEV, grid_type=GridType.CELL_PLUS_BOUNDARIES)
PSI = OutputKey(
...
Q = OutputKey("q", units=Units.DIMENSIONLESS, grid_type=GridType.FACE)
MAGNETIC_SHEAR = OutputKey(
    "magnetic_shear", units=Units.DIMENSIONLESS, grid_type=GridType.FACE
)
N_IMPURITY = OutputKey(
    "n_impurity",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
Z_IMPURITY = OutputKey(
    "Z_impurity",
...
MAIN_ION_FRACTIONS = OutputKey(
    "main_ion_fractions",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.SCALAR,
)
PRESSURE_THERMAL_E = OutputKey(
    "pressure_thermal_e",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
PRESSURE_THERMAL_I = OutputKey(
    "pressure_thermal_i",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
PRESSURE_THERMAL_TOTAL = OutputKey(
    "pressure_thermal_total",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
PRESSURE_FAST_I = OutputKey(
    "pressure_fast_i",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
PRESSURE_TOTAL_I = OutputKey(
    "pressure_total_i",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
PRESSURE_TOTAL = OutputKey(
    "pressure_total",
    units=Units.PASCAL,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
EI_EXCHANGE = OutputKey(
    "ei_exchange",
    units=Units.MW_PER_CUBIC_METER,
    grid_type=GridType.CELL,
)
PSI_FROM_IP = OutputKey(
...
J_TOROIDAL_TOTAL = OutputKey(
    "j_total",
    units=Units.AMPERE_PER_SQUARE_METER,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
J_TOROIDAL_OHMIC = OutputKey(
    "j_ohmic",
    units=Units.AMPERE_PER_SQUARE_METER,
    grid_type=GridType.CELL,
)
...
RHO_FACE = OutputKey("rho_face", units=Units.METER, grid_type=GridType.FACE)
RHO_CELL = OutputKey("rho_cell", units=Units.METER, grid_type=GridType.CELL)
TIME = OutputKey("time", units=Units.SECOND, grid_type=GridType.SCALAR)
...
# ---------------------------------------------------------------------------
P_HEAT_I = OutputKey("P_heat_i", units=Units.WATT, grid_type=GridType.SCALAR)
P_HEAT_E = OutputKey("P_heat_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_HEAT_TOTAL = OutputKey(
    "P_heat_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_SOL_I = OutputKey("P_SOL_i", units=Units.WATT, grid_type=GridType.SCALAR)
P_SOL_E = OutputKey("P_SOL_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_SOL_TOTAL = OutputKey(
    "P_SOL_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_AUX_I = OutputKey("P_aux_i", units=Units.WATT, grid_type=GridType.SCALAR)
P_AUX_E = OutputKey("P_aux_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_AUX_TOTAL = OutputKey(
    "P_aux_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_EXTERNAL_INJECTED = OutputKey(
    "P_external_injected", units=Units.WATT, grid_type=GridType.SCALAR
)
P_EXTERNAL_TOTAL = OutputKey(
    "P_external_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_EI_EXCHANGE_I = OutputKey(
    "P_ei_exchange_i", units=Units.WATT, grid_type=GridType.SCALAR
)
P_EI_EXCHANGE_E = OutputKey(
    "P_ei_exchange_e", units=Units.WATT, grid_type=GridType.SCALAR
)
P_AUX_GENERIC_I = OutputKey(
    "P_aux_generic_i", units=Units.WATT, grid_type=GridType.SCALAR
)
P_AUX_GENERIC_E = OutputKey(
    "P_aux_generic_e", units=Units.WATT, grid_type=GridType.SCALAR
)
P_AUX_GENERIC_TOTAL = OutputKey(
    "P_aux_generic_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_ALPHA_I = OutputKey("P_alpha_i", units=Units.WATT, grid_type=GridType.SCALAR)
P_ALPHA_E = OutputKey("P_alpha_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_ALPHA_TOTAL = OutputKey(
    "P_alpha_total", units=Units.WATT, grid_type=GridType.SCALAR
)
P_OHMIC_E = OutputKey("P_ohmic_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_BREMSSTRAHLUNG_E = OutputKey(
    "P_bremsstrahlung_e", units=Units.WATT, grid_type=GridType.SCALAR
)
P_CYCLOTRON_E = OutputKey(
    "P_cyclotron_e", units=Units.WATT, grid_type=GridType.SCALAR
)
P_ECRH_E = OutputKey("P_ecrh_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_RADIATION_E = OutputKey(
    "P_radiation_e", units=Units.WATT, grid_type=GridType.SCALAR
)
P_FUSION = OutputKey("P_fusion", units=Units.WATT, grid_type=GridType.SCALAR)
P_ICRH_E = OutputKey("P_icrh_e", units=Units.WATT, grid_type=GridType.SCALAR)
P_ICRH_I = OutputKey("P_icrh_i", units=Units.WATT, grid_type=GridType.SCALAR)
P_ICRH_TOTAL = OutputKey(
...
# ---------------------------------------------------------------------------
P_LH_HIGH_DENSITY = OutputKey(
    "P_LH_high_density", units=Units.WATT, grid_type=GridType.SCALAR
)
P_LH_MIN = OutputKey("P_LH_min", units=Units.WATT, grid_type=GridType.SCALAR)
P_LH_LOW_DENSITY = OutputKey(
    "P_LH_low_density", units=Units.WATT, grid_type=GridType.SCALAR
)
P_LH = OutputKey("P_LH", units=Units.WATT, grid_type=GridType.SCALAR)
N_E_MIN_P_LH = OutputKey(
    "n_e_min_P_LH",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.SCALAR,
)
...
# ---------------------------------------------------------------------------
E_FUSION = OutputKey("E_fusion", units=Units.JOULE, grid_type=GridType.SCALAR)
E_AUX_TOTAL = OutputKey(
    "E_aux_total", units=Units.JOULE, grid_type=GridType.SCALAR
)
E_OHMIC_E = OutputKey("E_ohmic_e", units=Units.JOULE, grid_type=GridType.SCALAR)
E_EXTERNAL_INJECTED = OutputKey(
    "E_external_injected", units=Units.JOULE, grid_type=GridType.SCALAR
)
E_EXTERNAL_TOTAL = OutputKey(
...
# ---------------------------------------------------------------------------
W_THERMAL_I = OutputKey(
    "W_thermal_i", units=Units.JOULE, grid_type=GridType.SCALAR
)
W_THERMAL_E = OutputKey(
    "W_thermal_e", units=Units.JOULE, grid_type=GridType.SCALAR
)
W_THERMAL_TOTAL = OutputKey(
    "W_thermal_total", units=Units.JOULE, grid_type=GridType.SCALAR
)
TAU_E = OutputKey("tau_E", units=Units.SECOND, grid_type=GridType.SCALAR)
H89P = OutputKey("H89P", units=Units.DIMENSIONLESS, grid_type=GridType.SCALAR)
H98 = OutputKey("H98", units=Units.DIMENSIONLESS, grid_type=GridType.SCALAR)
H97L = OutputKey("H97L", units=Units.DIMENSIONLESS, grid_type=GridType.SCALAR)
H20 = OutputKey("H20", units=Units.DIMENSIONLESS, grid_type=GridType.SCALAR)
W_POL = OutputKey("W_pol", units=Units.JOULE, grid_type=GridType.SCALAR)
LI3 = OutputKey("li3", units=Units.DIMENSIONLESS, grid_type=GridType.SCALAR)
DW_THERMAL_DT = OutputKey(
    "dW_thermal_dt", units=Units.WATT, grid_type=GridType.SCALAR
)
DW_THERMAL_DT_SMOOTHED = OutputKey(
...
# ---------------------------------------------------------------------------
T_E_VOLUME_AVG = OutputKey(
    "T_e_volume_avg", units=Units.KEV, grid_type=GridType.SCALAR
)
T_I_VOLUME_AVG = OutputKey(
    "T_i_volume_avg", units=Units.KEV, grid_type=GridType.SCALAR
)
N_E_VOLUME_AVG = OutputKey(
    "n_e_volume_avg",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.SCALAR,
)
N_I_VOLUME_AVG = OutputKey(
    "n_i_volume_avg",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.SCALAR,
)
N_E_LINE_AVG = OutputKey(
    "n_e_line_avg",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.SCALAR,
)
N_I_LINE_AVG = OutputKey(
    "n_i_line_avg",
    units=Units.INVERSE_CUBIC_METER,
    grid_type=GridType.SCALAR,
)
FGW_N_E_VOLUME_AVG = OutputKey(
    "fgw_n_e_volume_avg",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.SCALAR,
)
FGW_N_E_LINE_AVG = OutputKey(
    "fgw_n_e_line_avg",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.SCALAR,
)
...
T_E_SEPARATRIX = OutputKey(
    "T_e_separatrix", units=Units.KEV, grid_type=GridType.SCALAR
)
T_E_TARGET = OutputKey("T_e_target", units=Units.EV, grid_type=GridType.SCALAR)
...
# ---------------------------------------------------------------------------
B_0 = OutputKey("B_0", units=Units.TESLA, grid_type=GridType.SCALAR)
R_MAJOR = OutputKey("R_major", units=Units.METER, grid_type=GridType.SCALAR)
A_MINOR = OutputKey("a_minor", units=Units.METER, grid_type=GridType.SCALAR)
PHI_B = OutputKey("Phi_b", units=Units.WEBER, grid_type=GridType.SCALAR)
PHI_B_DOT = OutputKey(
    "Phi_b_dot", units=Units.WEBER_PER_SECOND, grid_type=GridType.SCALAR
)
RHO_B = OutputKey("rho_b", units=Units.METER, grid_type=GridType.SCALAR)
DRHO = OutputKey("drho", units=Units.METER, grid_type=GridType.SCALAR)
DRHO_NORM = OutputKey(
...
DELTA_UPPER = OutputKey(
    "delta_upper",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.FACE,
)
DELTA_LOWER = OutputKey(
    "delta_lower",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.FACE,
)
ELONGATION = OutputKey(
    "elongation",
    units=Units.DIMENSIONLESS,
    grid_type=GridType.CELL_PLUS_BOUNDARIES,
)
...
SOLVER_ITERATIONS = OutputKey(
    "solver_iterations",
    units=Units.NOT_APPLICABLE,
    grid_type=GridType.SCALAR,
)
SOLVER_RESIDUAL = OutputKey(
    "solver_residual",
    units=Units.NOT_APPLICABLE,
    grid_type=GridType.SCALAR,
)
SOLVER_ERROR = OutputKey(
    "solver_error",
    units=Units.NOT_APPLICABLE,
    grid_type=GridType.SCALAR,
)
