...
class QualikizInputs(quasilinear_transport_model.QuasilinearInputs):
  ...
  Z_eff_face: array_typing.Array
  q: array_typing.Array
  smag: array_typing.Array
  x: array_typing.Array
  Ti_Te: array_typing.Array
  log_nu_star_face: array_typing.Array
  normni: array_typing.Array
  alpha: array_typing.Array
  epsilon_lcfs: array_typing.Array

  # Also define the logarithmic gradients using standard QuaLiKiz notation.
  @property
  def Ati(self) -> array_typing.Array:
    return self.lref_over_lti

  @property
  def Ate(self) -> array_typing.Array:
  ...
  @property
  def Ani0(self) -> array_typing.Array:
    return self.lref_over_lni0

  @property
  def Ani1(self) -> array_typing.Array:
