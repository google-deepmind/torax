...
try:
  ...
  TGLFInterfaceType = tglf2py_lib.TGLFInterface
  TGLF2pyLibType = types.ModuleType
except (ImportError, ModuleNotFoundError, AttributeError):
  # At runtime, if the extension fails to import, then set it to None.
  tglf_interface = None
  tglf2py_lib = None
  TGLFInterfaceType = Any
  TGLF2pyLibType = Any


def _get_tglf_lib_and_interface() -> tuple[TGLF2pyLibType, TGLFInterfaceType]:  # pytype: disable=invalid-annotation
