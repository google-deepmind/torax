...
class FakeTGLFBasedTransportModel(
  ...
  def prepare_tglf_inputs(
      self,
      transport: tglf_based_transport_model.DynamicRuntimeParams,
  ...
  def _call_implementation(
      self,
      transport_runtime_params: tglf_based_transport_model.DynamicRuntimeParams,
...
class TGLFBasedTransportModelConfig(
  ...
  model_name: Literal["tglf_based"] = "tglf_based"
  ...
  def build_dynamic_params(self, t: chex.Numeric):
    ...
    return tglf_based_transport_model.DynamicRuntimeParams(
