...
class NormalizedLogarithmicGradients:
  ...
  lref_over_lti: array_typing.Array
  lref_over_lte: array_typing.Array
  lref_over_lne: array_typing.Array
  lref_over_lni0: array_typing.Array
  lref_over_lni1: array_typing.Array
...
def calculate_alpha(
  ...
  Returns:
    Alpha value as a array_typing.Array.
  """
  constants = constants_module.CONSTANTS
...
class QuasilinearInputs:
  ...
  Rmin: array_typing.Array  # minor radius [m].
  Rmaj: array_typing.Array  #  major radius [m].
