...
class WhileLoopBoundedWhileLoop(hijax.VJPHiPrimitive):
  ...
  def __init__(
    ...
    self.in_avals = (init_val, cond_consts, body_consts)
  ...
  def expand(self, init_val, cond_consts, body_consts):
...
def while_loop_bounded_while_loop(
  ...
  converted_cond_fun, cond_consts = jax.closure_convert(cond_fun, init_val)
  converted_body_fun, body_consts = jax.closure_convert(body_fun, init_val)
  return WhileLoopBoundedWhileLoop(
      ...
      max_steps=max_steps,
      cond_consts=jax.tree.map(jax.typeof, cond_consts),
      body_consts=jax.tree.map(jax.typeof, body_consts),
