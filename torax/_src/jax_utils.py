...
# pass throughs.
# Default to True for tests, False for production to maintain compatibility
# with persistent compilation cache.
...
def non_inlined_function(
    ...
    match implementation:
        case "while_loop":
            return _non_inlined_function_while_loop(f, static_argnames=static_argnames)
        case "pure_callback":
