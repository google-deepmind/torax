...
def _validate_source_model_config(
    ...
    if not hasattr(source_model_config, "model_name"):
        raise ValueError("The source model config must have a model_name attribute.")
    ...
    match source_name:
        ...
        case generic_particle_source_lib.GenericParticleSource.SOURCE_NAME:
            default_model_name = generic_particle_source_lib.DEFAULT_MODEL_FUNCTION_NAME
        ...
        case generic_current_source_lib.GenericCurrentSource.SOURCE_NAME:
            default_model_name = generic_current_source_lib.DEFAULT_MODEL_FUNCTION_NAME
        case _:
...
def register_source_model_config(
    ...
    current_annotation = sources_pydantic_model.Sources.model_fields[
        f"{source_name}"
    ].annotation
    current_types = get_args(current_annotation)
    new_model_name = source_model_config_class.model_fields["model_name"].default
