...
class SimulationStepFn:
  ...
  def __call__(
    ...
    stepper_numeric_outputs.stepper_iterations = stepper_iterations
    ...
    if static_runtime_params_slice.adaptive_dt:
      ...
      def body_fun(
        ...
        stepper_numeric_outputs.stepper_iterations = (
            updated_output.stepper_numeric_outputs.stepper_iterations + 1
        )
  ...
  while time_step_calculator.not_done(
    ...
    if log_timestep_info:
      _log_timestep(
          sim_state.t,
          sim_state.dt,
          sim_state.stepper_numeric_outputs.stepper_iterations,
      )
