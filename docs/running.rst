...
inspected on
`GitHub <https://github.com/google-deepmind/torax/tree/v1.0.0/torax/examples>`_ or
...
`basic_config.py <https://github.com/google-deepmind/torax/tree/v1.0.0/torax/examples/basic_config.py>`_.
