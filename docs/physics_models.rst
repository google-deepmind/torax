...
Time-derivate terms are calculated based on finite differences. Generalization
...
nonlinearity in the PDE system. TORAX currently offers three transport models:
...
built-in formula-based particle sources for the :math:`n_e` equation:
  ...
  - **Neutral Beam Injection (NBI):**  A Gaussian function models the ionization
    of neutral particles injected by a neutral beam.
